...
export default function WalletConnectButton({
  ...
  // ✅ Desktop-only: close on outside click + ESC
  useEffect(() => {
    if (isMobile) return; // <-- IMPORTANT: do not attach doc handlers on mobile
    ...
    <div ref={rootRef} className="relative">
      ...
      {open && isMobile ? (
        <>
          ...
          <div className="fixed left-0 right-0 bottom-0 z-[201] rounded-t-2xl border border-slate-800 bg-slate-950 shadow-2xl">
            ...
            {/* Fixed height sheet + internal scroll */}
            <div
